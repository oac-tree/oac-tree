...
#ifndef SUP_SEQUENCER_INSTRUCTION_INFO_H_
#define SUP_SEQUENCER_INSTRUCTION_INFO_H_

#include <sup/sequencer/attribute_info.h>
...
#endif  // SUP_SEQUENCER_INSTRUCTION_INFO_H_
